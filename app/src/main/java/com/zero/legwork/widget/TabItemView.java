package com.zero.legwork.widget;
...
public class TabItemView extends View {
    ...
    public TabItemView(Context context, AttributeSet attrs,
        ...
        for (int i = 0; i < n; i++) {
            ...
            switch (attr) {
                case R.styleable.TabItemView_tab_icon:
                    BitmapDrawable drawable = (BitmapDrawable) a.getDrawable(attr);
                    mIconBitmap = drawable.getBitmap();
                    break;
                case R.styleable.TabItemView_tab_color:
                    mColor = a.getColor(attr, 0xFF45C01A);
                    break;
                case R.styleable.TabItemView_tab_text:
                    mText = a.getString(attr);
                    break;
                case R.styleable.TabItemView_tab_text_size:
